...
CategoryPage = React.createClass({
  ...
  getMeteorData () {
    ...
    return {
      posts: Posts.find({ category: this.props.title }, {sort: {createdAt: -1}}).fetch(),
  ...
  componentDidMount() {
    var title = this.props.title + " | The Realm Gaming";
    DocHead.setTitle(title);

    var metaInfo = {name: "description", content: this.props.title + " - Forums at The Realm Gaming" };
